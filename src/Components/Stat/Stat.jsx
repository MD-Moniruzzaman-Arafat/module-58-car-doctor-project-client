...
const Stat = () => {
    return (
        <div className="stats stats-vertical lg:stats-horizontal w-full shadow mb-20  bg-[#151515] text-white ">

            <div className="stat text-center flex items-center justify-center py-10">
            ...
            <div className="stat text-center flex items-center justify-center py-10">
                ...
                <div>
                    <div className="text-sm font-medium">Need a repair? our address</div>
                    <div className="text-2xl font-bold">Liza Street, New York</div>
                </div>
            </div>
